...
function SDL_QueueAudio(dev: TSDL_AudioDeviceID; const data: pointer; len: Uint32): longint; lSDL;
function SDL_GetQueuedAudioSize(dev: TSDL_AudioDeviceID): Uint32; lSDL;
procedure SDL_ClearQueuedAudio(dev: TSDL_AudioDeviceID); lSDL;
